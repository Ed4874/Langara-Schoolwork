...
public class PurseTester
{
	   ...
	   */
	   public static void main(String[] args)
	   {
		      ...
		      System.out.println("b = " + b);
		      c.removeCoin(new Coin("quarter", 25));
		      System.out.println("c = " + c);
		      d.removeCoin(new Coin("dime", 10));
		      System.out.println("d = " + d + "\n");

		      //testing getHighestOccurrence
		   	  String highestOccurrence = b.getHighestOccurrence();
		   	  System.out.println(highestOccurrence + "\n");
		      ...
		      //testing getHighestCoinValue
		      String highestCoinValue = c.getHighestCoinValue();
		      System.out.println(highestCoinValue);
		      ...
		      System.out.println("Do e and f have the same coins? ");
